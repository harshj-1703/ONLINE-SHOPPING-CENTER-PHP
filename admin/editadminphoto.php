...
header("Location: ./editadminphoto.php");
...
<head>
    ...
    <link rel="stylesheet" href="./CSS/editadminphoto.css">
</head>
<body>
<table border="0" cellspacing="5" cellpadding="5">
    ...
    <tr>
        <td>
        <img src="../imges/adminprofile/<?php echo $_SESSION['profileimage']?>" id="bigprofilephoto">
        </td>
    </tr>
    <tr><td>
    <form method="post" action="./editadminphoto.php" enctype="multipart/form-data">
    ...
    <td>
       ...
       <form method="post" action="./editadminphoto.php">
