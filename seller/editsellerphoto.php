...
{ 
    ...
    $sql = "UPDATE seller SET image='$pname' WHERE email='$email'";
...
header("Location: ./editsellerphoto.php");
...
<head>
    ...
    <link rel="stylesheet" href="./CSS/editsellerphoto.css">
</head>
<body>
<table border="0" cellspacing="5" cellpadding="5">
    ...
    <tr>
        <td>
        <img src="../imges/sellerprofile/<?php echo $_SESSION['profileimage']?>" id="bigprofilephoto">
        </td>
    </tr>
    <tr><td>
    <form method="post" action="./editsellerphoto.php" enctype="multipart/form-data">
    ...
    <td>
       ...
       <form method="post" action="./editsellerphoto.php">
