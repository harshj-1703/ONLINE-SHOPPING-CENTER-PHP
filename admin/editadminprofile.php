...
{ 
    ...
    $pincode = $_POST["upincode"];
        ...
        dateofbirth='$birthdate',gender='$gender',address='$address',country='$country',
...
<head>
    ...
    <link rel="stylesheet" href="./CSS/editadminprofile.css">
...
<body >
    ...
    <form name="registrationform" method="post" action="./editadminprofile.php" enctype="multipart/form-data">
        <table border="0"  cellspacing="10" cellpadding="10">
            ...
            <tr>
                <td>
                    ...
                    <input type="date" id="t4" class="ip" name="ubirthdate" value="<?php echo $row['dateofbirth'];?>" required/>
                </td>
                <td>
