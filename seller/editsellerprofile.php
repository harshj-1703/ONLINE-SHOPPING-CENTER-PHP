...
$sql1 = "select *from seller where email = '$email' and status='1'";  
...
{ 
    ...
    $pincode = $_POST["upincode"];
        ...
        $sql = "UPDATE seller SET fname='$fname',mname='$mname',lname='$lname',
        ...
        $query = mysqli_query($conn,$sql);
            ...
            header("Location: ./editsellerprofile.php");
...
<body >
    ...
    <form name="registrationform" method="post" action="./editsellerprofile.php" enctype="multipart/form-data">
        ...
        <form method="post" action="./editsellerprofile.php">
        <td>
