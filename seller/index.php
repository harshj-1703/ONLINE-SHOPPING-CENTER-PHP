...
if(isset($_POST['login']))
{
    ...
    $password = $_POST["password"];
        ...
        $sql = "select *from seller where email = '$email' and password = '$password' and status='1'";  
...
<body>
    ...
    <form method="post" action="./index.php">
        <table id="logintable">
            <tr>
                <label id="emaillabel" class="loginlabels">SELLER EMAIL ID :&nbsp; </label>
            </tr>
            <br>
            <br>
            <tr>
            ...
            <tr>
                ...
                &nbsp;
                <a href="./sellerregistration.php" id="signup" class="loginlinks">SignUp</a>
            </tr>
        </table>
    </form>
    </div>
