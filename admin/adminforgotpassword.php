...
if($count == 1){  
    ...
    try {
        ...
        $mail->addAddress($email, 'HIII IWT STUDENT');
        $mail->addReplyTo('phptest1703@gmail.com', 'HARSH JOLAPARA'); // to set the reply to
    
        // Setting the email content
        $mail->IsHTML(true);
        $mail->Subject = "YOUR PASSWORD";
        $mail->Body = 'HI '.$fname.' '.$lname. ',<br><br><p align="center"> YOUR ADMIN LOGIN PASSWORD WAS <b>' .$password. '</b>.<br> 
...
<body>
    ...
    <div class="message"><?php if(isset($message)) { echo $message; } ?></div>
        ...
        <tr class="tableheader">
            <td colspan="2">FORGOT PASSWORD FOR ADMIN</td>
        </tr>
        <tr>
        ...
        <form method="post" action="./adminforgotpassword.php">
